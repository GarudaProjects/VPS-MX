...
if [ ! -d "$INSTALL_DIR" ]; then
    ...
    wget https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/zzupdate-master/zzupdate.default-si.conf -O /usr/local/vpsmxup/vpsmxup.default.conf  &> /dev/null
	...
	chmod +x /usr/local/vpsmxup/vpsmxup.default.conf
	rm -rf /root/VPS-MX
    wget https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX -O /root/VPS-MX &> /dev/null
	chmod +x /root/VPS-MX

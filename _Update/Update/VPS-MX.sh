...
function_verify () {
wget -O /usr/bin/trans https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/trans &> /dev/null
wget -O /etc/versin_script https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/Version &> /dev/null
wget -O /usr/bin/SPR https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/SPR/SPR &> /dev/null
chmod +x /usr/bin/SPR
## lognull
...
wget -O /etc/versin_script_new https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/Install &>/dev/null
msg -bar2
...
echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/Install &>/dev/null'>> .bashrc
echo 'echo ""'>> .bashrc
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/trans &> /dev/null
wget -O /bin/Desbloqueo.sh https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/Desbloqueo.sh &> /dev/null
chmod +x /bin/Desbloqueo.sh
wget -O /bin/monitor.sh https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/Monitor-Service/monitor.sh &> /dev/null
chmod +x /bin/monitor.sh
wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/Monitor-Service/estilos.css &> /dev/null
msg -bar2
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @Kalix1 ❌\033[1;33m ]"
